...
(cl:defmethod cl:initialize-instance :after ((m <vel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'vel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aruco-msg:<vel> is deprecated: use aruco-msg:vel instead.")))

(cl:ensure-generic-function 'linear_x-val :lambda-list '(m))
(cl:defmethod linear_x-val ((m <vel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aruco-msg:linear_x-val is deprecated.  Use aruco-msg:linear_x instead.")
  (linear_x m))

(cl:ensure-generic-function 'linear_y-val :lambda-list '(m))
(cl:defmethod linear_y-val ((m <vel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aruco-msg:linear_y-val is deprecated.  Use aruco-msg:linear_y instead.")
  (linear_y m))

(cl:ensure-generic-function 'angular_z-val :lambda-list '(m))
(cl:defmethod angular_z-val ((m <vel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aruco-msg:angular_z-val is deprecated.  Use aruco-msg:angular_z instead.")
  (angular_z m))
